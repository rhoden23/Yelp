...
//        return searchWithTerm(term, completion: completion)
//    }
    
    func searchWithTerm(_ term: String, sort: YelpSortMode?=nil, categories: [String]?=nil, openNow: Bool?=nil, offset:Int?=nil, completion: @escaping ([Business]?, Error?) -> Void) -> AFHTTPRequestOperation {
